<?php
/*
Template Name: Publications Personal Development
*/
?>
    ...
    <section class="container-fluid publication-body">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-tabs d-flex justify-content-center f_j_m t14 c_222" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-uppercase active" id="personal-development-tab" data-toggle="tab" onclick="window.location.href='<?php get_bloginfo('baseurl'); ?>/krauthammer/publications/personal-development/'" role="tab" aria-controls="personal-development-tab-pane" aria-selected="true">Personal
                                Development</button>
                        </li>
                        <li class="nav-item" role="presentation">
            ...
            <div class="body row"> 
                        <?php  
                        $pageNo = "?page=" . $page;
                            publicationDisplay("personal-development", $pageNo); 
                        ?>  
            </div> 
            <div class="row">
                <div class="col-12"> 
                        <ul class="nav pagination d-flex align-items-center justify-content-center"> 
                            <?php 
                                paginationDisplay("personal-development", $pageNo); 
                            ?>
                        </ul> 
                </div>
            </div>
