<?php
/*
Template Name: Publications Interview
*/
?>
    ...
    <section class="container-fluid publication-body">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-tabs d-flex justify-content-center f_j_m t14 c_222" id="myTab" role="tablist">
                        <li class="nav-item">
                            <button class="nav-link text-uppercase active" id="interview-tab" data-toggle="tab" onclick="window.location.href='<?php get_bloginfo('baseurl'); ?>/krauthammer/publications/interview'" role="tab" aria-controls="interview-tab-pane" aria-selected="false">Interview</button>
                        </li>
            ...
            <div class="body row"> 
                        <?php  
                         $pageNo = '?page=' . $page;    
                            echo publicationDisplay("interview", $pageNo); 
                        ?>  
            </div> 
            <div class="row">
                <div class="col-12"> 
                        <ul class="nav pagination d-flex align-items-center justify-content-center"> 
                            <?php 
                            $pageNo = '?page=' . $page;  
                                paginationDisplay("interview", $pageNo); 
                            ?>
                        </ul> 
                </div>
            </div>
