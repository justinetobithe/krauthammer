<?php
/*
Template Name: Publications Sales Articles
*/
?>
    ...
    <section class="container-fluid publication-body">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-tabs d-flex justify-content-center f_j_m t14 c_222" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-uppercase active" id="sales-articles-tab" data-toggle="tab" onclick="window.location.href='<?php get_bloginfo('baseurl'); ?>/krauthammer/publications/sales-articles'" role="tab" aria-controls="sales-acrticles-tab-pane" aria-selected="false">Sales Articles</button>
                        </li>
                        <li class="nav-item" role="presentation">
            ...
            <div class="body row"> 
                        <?php  
                         $pageNo = '?page=' . $page;    
                            echo publicationDisplay("sales-articles", $pageNo); 
                        ?>  
            </div> 
            <div class="bottom row">
                <div class="col-12"> 
                        <ul class="nav pagination d-flex align-items-center justify-content-center"> 
                            <?php 
                            $pageNo = '?page=' . $page;  
                                paginationDisplay("sales-articles", $pageNo); 
                            ?>
                        </ul> 
                </div>
            </div>
