<?php
/*
Template Name: Publications Video
*/
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6 d-flex flex-column align-items-start f_j_b t16 c_141515">
                    <h1 class="title f_j_bld t50 c_2a7db1">Publications</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="container-fluid publication-body">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-tabs d-flex justify-content-center f_j_m t14 c_222" id="myTab" role="tablist">
                        <li class="nav-item">
                            <button class="nav-link text-uppercase" id="leadership-and-managment-tab" data-toggle="tab" onclick="window.location.href='<?php get_bloginfo('baseurl'); ?>/krauthammer/publications/leadership-and-management/'" role="tab" aria-controls="leadership-and-management" aria-selected="false">Leadership
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-uppercase active" id="videos-tab" data-toggle="tab" onclick="window.location.href='<?php get_bloginfo('baseurl'); ?>/krauthammer/publications/video/'" role="tab" aria-controls="videos-tab-pane" aria-selected="true">Videos</button>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="body row"> 
                        <?php  
                         $pageNo = "?page=" . $page;
                            publicationDisplay("video", $pageNo); 
                        ?>  
            </div> 
            <div class="row">
                <div class="col-12"> 
                        <ul class="nav pagination d-flex align-items-center justify-content-center"> 
                            <?php 
                                paginationDisplay("video", $pageNo); 
                            ?>
                        </ul> 
                </div>
            </div>
