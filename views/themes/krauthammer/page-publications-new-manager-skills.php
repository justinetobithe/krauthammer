<?php
/*
Template Name: Publications New Manager Skills
*/
?>
    ...
    <section class="container-fluid publication-body">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-tabs d-flex justify-content-center f_j_m t14 c_222" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-uppercase active" id="new-manager-skills-tab" data-toggle="tab" onclick="window.location.href='<?php get_bloginfo('baseurl'); ?>/krauthammer/publications/new-manager-skills'" role="tab" aria-controls="new-manager-skills-tab-pane" aria-selected="false">New Manager Skills</button>
                        </li>
                        <li class="nav-item" role="presentation">
            ...
            <div class="body row"> 
                        <?php  
                         $pageNo = '?page=' . $page;    
                            echo publicationDisplay("new-manager-skills", $pageNo); 
                        ?>  
            </div> 
            <div class="bottom row">
                <div class="col-12"> 
                        <ul class="nav pagination d-flex align-items-center justify-content-center"> 
                            <?php 
                            $pageNo = '?page=' . $page;  
                                paginationDisplay("new-manager-skills", $pageNo); 
                            ?>
                        </ul> 
                </div>
            </div>
