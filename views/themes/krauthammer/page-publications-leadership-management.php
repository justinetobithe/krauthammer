<?php
/*
Template Name: Publications Leadership Management
*/
?>
    ...
    <section class="container-fluid publication-body">
        <div class="container">
                ...
                <div class="col-12">
                    <ul class="nav nav-tabs d-flex justify-content-center f_j_m t14 c_222" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-uppercase active" id="leadership-and-management-tab" data-toggle="tab" onclick="window.location.href='<?php get_bloginfo('baseurl'); ?>/krauthammer/publications/leadership-and-management'" role="tab" aria-controls="leadership-and-management-tab-pane" aria-selected="false">Leadership and Management</button>
                        </li>
                        <li class="nav-item" role="presentation">
            ...
            <div class="body row"> 
                        <?php  
                            $pageNo = "?page=" . $page;
                            publicationDisplay("leadership-management", $pageNo); 
                        ?>  
            </div> 
            <div class="bottom row">
                <div class="col-12">
                        <ul class="nav pagination d-flex align-items-center justify-content-center">
                            <?php 
                                 paginationDisplay("leadership-management", $pageNo); 
                            ?>
                        </ul>
                </div>
            </div> 
