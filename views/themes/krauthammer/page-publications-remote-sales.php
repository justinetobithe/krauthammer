<?php
/*
Template Name: Publications Remote Sales
*/
?>
    ...
    <section class="container-fluid publication-body">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-tabs d-flex justify-content-center f_j_m t14 c_222" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <button class="nav-link text-uppercase active" id="remote-sales-tab" data-toggle="tab" onclick="window.location.href='<?php get_bloginfo('baseurl'); ?>/krauthammer/publications/remote-sales'" role="tab" aria-controls="remote-sales-tab-pane" aria-selected="false">Remote Sales</button>
                        </li>
                        <li class="nav-item" role="presentation">
            ...
            <div class="body row"> 
                        <?php  
                         $pageNo = '?page=' . $page;    
                            echo publicationDisplay("remote-sales", $pageNo); 
                        ?>  
            </div> 
            <div class="bottom row">
                <div class="col-12"> 
                        <ul class="nav pagination d-flex align-items-center justify-content-center"> 
                            <?php 
                            $pageNo = '?page=' . $page;  
                                paginationDisplay("remote-sales", $pageNo); 
                            ?>
                        </ul> 
                </div>
            </div>
