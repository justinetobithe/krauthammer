<?php
/*
Template Name: Publications Personal Development Articles
*/
?>
    ...
    <section class="container-fluid publication-body">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-tabs d-flex justify-content-center f_j_m t14 c_222" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-uppercase active" id="personal-development-articles-tab" data-toggle="tab" onclick="window.location.href='<?php get_bloginfo('baseurl'); ?>/krauthammer/publications/personal-development-articles'" role="tab" aria-controls="personal-development-articles-tab-pane" aria-selected="true">Personal Development Articles</button>
                        </li>
                        <li class="nav-item">
            ...
            <div class="body row"> 
                        <?php  
                         $pageNo = '?page=' . $page;    
                            echo publicationDisplay("personal-development-articles", $pageNo); 
                        ?>  
            </div> 
            <div class="bottom row">
                <div class="col-12"> 
                        <ul class="nav pagination d-flex align-items-center justify-content-center"> 
                            <?php 
                            $pageNo = '?page=' . $page;  
                                paginationDisplay("personal-development-articles", $pageNo); 
                            ?>
                        </ul> 
                </div>
            </div>
