<?php
/*
Template Name: Publications Sales Excellence
*/
?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-tabs d-flex justify-content-center f_j_m t14 c_222" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-uppercase active" id="sales-excellence-tab" data-toggle="tab" onclick="window.location.href='<?php get_bloginfo('baseurl'); ?>/krauthammer/publications/sale-excellence'" role="tab" aria-controls="sales-excellence-tab-pane" aria-selected="true">Sales Excellence</button>
                        </li> 
                    </ul>
                </div>
            </div>
            <div class="body row"> 
                        ...
                        $pageNo = '?page=' . $page;    
                             ...
                             publicationDisplay("sales-excellence", $pageNo); 
                        ?>  
            </div> 
            <div class="bottom row">
                <div class="col-12"> 
                        <ul class="nav pagination d-flex align-items-center justify-content-center"> 
                            <?php 
                                paginationDisplay("sales-excellence", $pageNo); 
                            ?>
                        </ul> 
                </div>
            </div>
