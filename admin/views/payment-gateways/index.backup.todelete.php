                    ...
                    <div class="accordion-body collapse" id="collapse-1">
                      <div class="accordion-inner">
                        <div class="payment-method">
                          ...
                          <div>
                            <p class="alert alert-warning">Paypal Subscription Plan is not yet Created. <a href="javascript:void(0)" id="btn-subscription-test">Click to test</a></p>
                            <hr>
                          </div>
													...
													<div class="form-horizontal">
														...
														<div class="control-group">
															...
															<div class="controls">
																<div class="row-fluid">
																	<input type="text" class="input span12 method_option" data-name="paypal_subscription_email" value="<?php echo isset($options['paypal_subscription_email']) ? $options['paypal_subscription_email'] : ''; ?>" />
																</div>
															</div>
														</div>
                            <div class="control-group">
                              <div class="row-fluid">
                                ...
                                <div class="span3">
                                  ...
                                  <div class="controls">
                                    <label>
                                      <input name="paypal_subscription_sandbox" id="paypal_subscription_sandbox" data-name="paypal_subscription_sandbox" class="ace ace-switch ace-switch-2 method_option" type="checkbox" <?php echo isset($options['paypal_subscription_sandbox']) && $options['paypal_subscription_sandbox'] == 'Y'? 'checked="checked"': ''; ?>>
                                      <span class="lbl"></span>
                                    </label>
                                  </div>
                                </div>
                              ...
                              <div class="tab-content">
                                <div id="tab-subscription-1" class="tab-pane in active">
                                  <div class="control-group">
                                    ...
                                    <div>
                                      <div class="row-fluid">
                                        <input type="text" class="input span12 method_option" data-name="paypal_subscription_sandbox_client_id" value="<?php echo isset($options['paypal_subscription_sandbox_client_id']) ? $options['paypal_subscription_sandbox_client_id'] : ''; ?>" />
                                      </div>
                                    </div>
                                  </div>
                                  <div class="control-group">
                                    ...
                                    <div>
                                      <div class="row-fluid">
                                        <input type="text" class="input span12 method_option" data-name="paypal_subscription_sandbox_secret" value="<?php echo isset($options['paypal_subscription_sandbox_secret']) ? $options['paypal_subscription_sandbox_secret'] : ''; ?>" id="sandbox-subscription-secret"/>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="text" class="input span12 method_option" data-name="paypal_subscription_plan_name" placeholder="Enter Plan name" value="<?php echo isset($options['paypal_subscription_plan_name']) ? $options['paypal_subscription_plan_name'] : ''; ?>" />
                              </div>
                            </div>
                            <div class="control-group">
                              <label class="control-label" for=""><small>Plan Description: </small></label>
                              <div class="controls">
                                <textarea rows="5" class="input method_option span12" data-name="paypal_subscription_plan_description" placeholder="Enter the description of the plan (Max: 127 characters)" ><?php echo isset($options['paypal_subscription_plan_description']) ? $options['paypal_subscription_plan_description'] : ''; ?></textarea>
                              </div>
                            </div>
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <div class="row-fluid">
                                  <div class="span3">
                                    <select class="input method_option chosen-select" data-name="paypal_subscription_plan_type" >
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <div class="row-fluid">
                                  <div class="span3">
                                    <select class="input method_option chosen-select" data-name="paypal_subscription_plan_auto_billing" >
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <div class="row-fluid">
                                  <div class="span3">
                                    <select class="input method_option chosen-select" data-name="paypal_subscription_plan_initial_fail_action" >
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <div class="row-fluid">
                                  <div class="span3">
                                    <input type="text" class="input span12 method_option" data-name="paypal_subscription_plan_max_fail_attempts" placeholder="Enter Max Fail Attempts" value="<?php echo isset($options['paypal_subscription_plan_max_fail_attempts']) ? $options['paypal_subscription_plan_max_fail_attempts'] : '0'; ?>" />
                                  </div>
                                  <div class="span9">
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="text" class="input span12 method_option" data-name="paypal_subscription_url_confirmed" placeholder="Enter URL to redirect after payment is completed" value="<?php echo isset($options['paypal_subscription_url_confirmed']) ? $options['paypal_subscription_url_confirmed'] : ''; ?>"  />
                              </div>
                            </div>
                            <div class="control-group">
                              <label class="control-label" for=""><small>Cancel URL</small></label>
                              <div class="controls">
                                <input type="text" class="input span12 method_option" data-name="paypal_subscription_url_cancelled" placeholder="Enter URL to redirect after payment is cancelled" value="<?php echo isset($options['paypal_subscription_url_cancelled']) ? $options['paypal_subscription_url_cancelled'] : ''; ?>" />
                              </div>
                            </div>
                              ...
                              <div class="tab-content">
                                <div id="tab-subscription-payment-1" class="tab-pane in active">
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <textarea type="text" row="5" class="input span12 method_option" data-name="paypal_subscription_title_trial" placeholder="Enter Title."><?php echo isset($options['paypal_subscription_title_trial']) ? $options['paypal_subscription_title_trial'] : ''; ?></textarea>
                                    </div>
                                  </div>
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <div class="span4">
                                        <input type="text" class="input span12 method_option" data-name="paypal_subscription_amount_trial" placeholder="Enter trial amount. Set to 0 if free." value="<?php echo isset($options['paypal_subscription_amount_trial']) ? $options['paypal_subscription_amount_trial'] : ''; ?>"  />
                                      </div>
                                      <p class="span8">The amount of the charge to make at the end of each payment cycle for this definition.</p>
                                    </div>
                                  </div>
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <div class="span4">
                                        <select class="input method_option chosen-select" data-name="paypal_subscription_frequency_trial" >
                                      ...
                                      <p class="span8"><small>The frequency of the payment in this definition.</small></p>
                                    </div>
                                  </div>
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <div class="span4">
                                        <input type="number" class="input span12 method_option" data-name="paypal_subscription_frequency_interval_trial" placeholder="Enter frequency interval" value="<?php echo isset($options['paypal_subscription_frequency_interval_trial']) ? $options['paypal_subscription_frequency_interval_trial'] : ''; ?>"  />
                                      </div>
                                      <p class="span8"><small>The interval at which the customer is charged. Value cannot be greater than <strong>12</strong> months.</small></p>
                                    </div>
                                  </div>
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <div class="span4">
                                        <input type="number" class="input span12 method_option" data-name="paypal_subscription_cycle_trial" placeholder="Enter payment cycle" value="<?php echo isset($options['paypal_subscription_cycle_trial']) ? $options['paypal_subscription_cycle_trial'] : ''; ?>"  />
                                      </div>
                                      <p class="span8"><small>The number of payment cycles. For infinite plans with a regular payment definition, set cycles to <strong>0</strong>.</small></p>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div id="tab-subscription-payment-2" class="tab-pane">
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <textarea type="text" row="5" class="input span12 method_option" data-name="paypal_subscription_title" placeholder="Enter Title."><?php echo isset($options['paypal_subscription_title']) ? $options['paypal_subscription_title'] : ''; ?></textarea>
                                    </div>
                                  </div>
                                  <div class="control-group">
                                    <label class="control-label" for=""><small>Amount</small></label>
                                    <div class="controls">
                                      <div class="span4">
                                        <input type="text" class="input span12 method_option" data-name="paypal_subscription_amount" placeholder="Enter the Regular Subscription amount" value="<?php echo isset($options['paypal_subscription_amount']) ? $options['paypal_subscription_amount'] : ''; ?>"  />
                                      </div>
                                      <p class="span8">The amount of the charge to make at the end of each payment cycle for this definition.</p>
                                    </div>
                                  </div>
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <div class="span4">
                                        <select class="input method_option chosen-select" data-name="paypal_subscription_frequency" >
                                  ...
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <div class="span4">
                                        <input type="number" class="input span12 method_option" data-name="paypal_subscription_frequency_interval" placeholder="Enter frequency interval" value="<?php echo isset($options['paypal_subscription_frequency_interval']) ? $options['paypal_subscription_frequency_interval'] : ''; ?>"  />
                                      </div>
                                      <p class="span8"><small>The interval at which the customer is charged. Value cannot be greater than <strong>12</strong> months.</small></p>
                                    </div>
                                  </div>
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <div class="span4">
                                        <input type="number" class="input span12 method_option" data-name="paypal_subscription_cycle" placeholder="Enter payment cycle" value="<?php echo isset($options['paypal_subscription_cycle']) ? $options['paypal_subscription_cycle'] : ''; ?>"  />
                                      </div>
                                      <p class="span8"><small>The number of payment cycles. For infinite plans with a regular payment definition, set cycles to <strong>0</strong>.</small></p>
                                    </div>
                                  </div>
														...
														<div class="control-group">
															...
															<div class="controls">
																<div class="row-fluid">
																	<a href="javascript:void(0)" id="paypal_subscription_manage_button" class="btn btn-small btn-primary"><i class="icon icon-cog"></i>Manage Paypal Button</a>
                                  <a href="javascript:void(0)" id="paypal_subscription_manual_button" class="btn btn-small btn-success"><i class="icon icon-zoom-in"></i>Read Guide</a>
																	<a href="javascript:void(0)" id="paypal_subscription_manual_button" class="btn btn-small btn-inverse"><i class="icon icon-bookmark"></i>View Plans</a>
																</div>
															</div>
														</div>
													</div>
