...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Forgot Password- Ace Admin</title>
	...
	<body class="login-layout">
													...
													<fieldset>
														<label>
															<span class="block input-icon input-icon-right">
																<input type="email" class="span12" placeholder="Email" id="txt_email"/>
																<i class="icon-envelope"></i>
															</span>
														</label>
													
														<div class="clearfix">
															<button onclick="return false;" id="btn_forgot_password" class="width-35 pull-right btn btn-small btn-danger">
																<i class="icon-lightbulb" id="icon_forgot_password"></i>
																<i class="icon-spinner icon-spin orange bigger-125" id="loading_forgot_password"></i>
																Send Me!
															</button>
														</div>
													</fieldset>
        ...
        <script type="text/javascript" src="<?php echo URL; ?>assets/js/controllers/<?php echo getJavascriptByUrl('forgot-password'); ?>"></script>
