			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="well well-small">
						...
						<div>
							<input type="text" id="title" class="span10"  value="Untitled" style="margin-bottom: 0;"/>
						</div>
					</div>
						...
						<div class="widget-body">
							<div class="widget-main">
								<div class="row-fluid">
									<div class="span6">
										<p>To: </p>
										<div><input type="text" id='mail_to' value="<?php //echo $admin_email; ?>" class="span12"></div>
										<p>From: </p>
										<div><input type="text" id='mail_from' value="[your-name] <[your-email]>" class="span12"></div>
										<p>Subject: </p>
										<div><input type="text" id='mail_subject' value="[your-subject]" class="span12"></div>
										<p>Additional Header: </p>
										<div><textarea class="span12" id='mail_additional_header' cols="30" rows="5">

										</textarea></div>
										<p>File Attachments: </p>
										<div><input type="text" id='mail_file_attachment' class="span12"></div>
										<div class="checkbox" style="position:relative;margin-left:-40px;"><label class="checkbox"><input type="checkbox" id="mail_html_content_type"  class="ace" > <span class="lbl"></span> <small>Use HTML content type</small> </label></div>
					...
					<div class="widget-box">
						...
						<div class="widget-body">
							<div class="widget-main">
								<div class="row-fluid">
									<div class="span6">
										<div class="checkbox" style="position:relative;margin-left:-40px;"><label class="checkbox"><input type="checkbox" id="mail2_active"  class="ace" > <span class="lbl"></span> <small>Use mail (2)</small> </label></div>
										<br />
										<div class='mail2_panel disappear' style="display: none">
											<p>To: </p>
											<div><input type="text" id='mail2_to' value="<?php //echo $admin_email; ?>" class="span12"></div>
											<p>From: </p>
											<div><input type="text" id='mail2_from' value="[your-name] <[your-email]>" class="span12"></div>
											<p>Subject: </p>
											<div><input type="text" id='mail2_subject' value="[your-subject]" class="span12"></div>
											<p>Additional Header: </p>
											<div><textarea class="span12" id='mail2_additional_header' cols="30" rows="5">

											</textarea></div>
											<p>File Attachments: </p>
											<div><input type="text" id='mail2_file_attachment' class="span12"></div>
											<div class="checkbox" style="position:relative;margin-left:-40px;"><label class="checkbox"><input type="checkbox" id="mail2_html_content_type"  class="ace" > <span class="lbl"></span> <small>Use HTML content type</small> </label></div>
										</div>
									</div>
									<div class="span6">
										<br /><br />
										<div class='mail2_panel disappear' style="display: none">
											...
											<p>Message body: </p>
											<div>
												<textarea cols="30" id='mail2_message_body' rows="20" class="span12"><?php echo $mail_1_message_body ?></textarea>
											</div>
					...
					<div class="widget-box collapsed">
						...
						<div class="widget-body">
							<div class="widget-main">
								<div class="row-fluid">
									<textarea class="span12" cols="30" id="additional_settings" rows="15"></textarea>
								</div>
							</div>
						</div>
					</div>
                    ...
                    <div class="controls">
                      <label>
                        <input id="enable-recaptcha" name="enable-recaptcha" type="checkbox" class="ace ace-switch ace-switch-7">
                        <span class="lbl"></span>
                      </label>
	                  </div>
	                </div>
