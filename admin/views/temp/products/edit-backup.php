                            ...
                            <div class="span8">
                                <div class="widget-box" style="margin-bottom:10px; border:none;">
                                    ...
                                    <div style="margin-bottom:5px;">
                                        <input type="text" name ="url_slug" class="input-xxlarge" id="txt_url_slug" placeholder = "URL Slug" value="<?php echo $products['url_slug'];?>">
                                            ...
                                            <div class="tab-content">
                                                <div id="home3" class="tab-pane in active" style="overflow-x: hidden;">
                                                    <div>
                                                        ...
                                                        <div class="control-group">
                                                            <label class="control-label" for="txt_max_order_qty">Max. Order Qty:</label>
                                                                <div class="controls">
                                                                    <div class="span7 input-group">
                                                                            <input type="text" id="txt_max_order_qty" class="input-xlarge" name="product_max_order_qty" value="<?php if($products['max_order_qty'] > 0){echo $products['max_order_qty'];} ?>"/>
                                                                    </div>
                                                                </div>
                                                        </div>
                                                        <div class="control-group">
                                                            <label class="control-label" for="txt_interval">Qty Interval:</label>
                                                                <div class="controls">
                                                                    <div class="span7 input-group">
                                                                            <input type="text" id="txt_interval" class="input-xlarge" name="product_interval" value="<?php if($products['qty_interval'] > 0){echo $products['qty_interval'];} ?>"/>
                                                                    </div>
                                                                </div>
                                                        </div>
                                                        <div class="control-group">
                                                            <label class="control-label" for="txt_qty_label">Qty Label:</label>
                                                                <div class="controls">
                                                                    <div class="span7 input-group">
                                                                            <input type="text" id="txt_qty_label" class="input-xlarge" name="product_qty_label" value="<?php echo $products['qty_label']; ?>"/>
                                                                    </div>
                                                                </div>
                                                        </div>
                                                    </div>
