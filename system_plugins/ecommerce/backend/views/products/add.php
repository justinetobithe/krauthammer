...
<div class="main-content">
	<div class="page-content">
		...
		<form class="form-horizontal" id="add_product_form" action="<?php echo URL;?>products/addProduct" enctype="multipart/form-data" method="post" onsubmit="return validateForm()">
			<div class="row-fluid">
				...
				<div class="span9">
					<div class="widget-box" style="margin-bottom:10px;  border:none;">
						...
						<div style="margin-bottom:5px;">
							<input type="text" name ="url_slug" class="input-large" id="txt_url_slug" style="width:98%;" placeholder = "URL Slug">
						</div>
                  ...
                  <div class="widget-header header-color-blue2">
                    <h4 class="lighter smaller">Product Detail</h4>
                  </div>
                  <div class="widget-body">
                    <div class="widget-main">
											<div class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														<div class="span7 input-group">
															<input type="text" id="txt_max_order_qty" class="input-xlarge" name="product_max_order_qty" value=""/>
														</div>
													</div>
												</div>
												<div class="control-group">
													...
													<div class="controls">
														<div class="span7 input-group">
															<input type="text" id="txt_interval" class="input-xlarge" name="product_interval" value=""/>
														</div>
													</div>
												</div>
												<div class="control-group">
													...
													<div class="controls">
														<div class="span7 input-group">
															<input type="text" id="txt_qty_label" class="input-xlarge" name="product_qty_label" value=""/>
														</div>
													</div>
												</div>
											</div>
							...
							<div id="profile3" class="tab-pane">
								<div class="widget-box">
                  <div class="widget-header header-color-blue2">
                    <h4 class="lighter smaller">Product Gallery</h4>
                  </div>
                  <div class="widget-body">
                    <div class="widget-main">
                      <div class="row-fluid"> 
                      ...
                      <input type="hidden" name="product_tabs" id="hdn_products_tab">
											<div class="form-horizontal">
												...
												<div class="widgets_tabs">
													<div class="widget-box product_tabs">
														<div class="widget-header header-color-blue2" style="padding: 5px 7px;">
															<div>
																<input type="text" class="input-xlarge title" placeholder="Tab Title">
																	<div class="widget-toolbar">
																		<a href="#" data-action="" onclick="collapse_tab(0); return false;" style="color: #C7C5D1;">
																			<i class="icon-chevron-up collapse" style="background-color: rgba(0,0,0,0);"></i>
																		</a>
																	</div>
																</div> 
																<input type="hidden" class="id_for_collapse" value=0>
															</div>
														<div class="widget-body">
															<div class="widget-main">
																<textarea class="textarea_product_tabs" id="tab_desc0"></textarea>
															</div>
														</div>
													</div>
                    ...
                    <div class="widget-main">
                      <div class="form-horizontal">
							...
							<div id="additional_files" class="tab-pane">
								<div class="widget-box">
                  <div class="widget-header header-color-blue2">
                    <h4 class="lighter smaller">Product Additional Files</h4>
                  </div>
                  <div class="widget-body">
                    <div class="widget-main">
											<div id='alert_seo_settings'></div>
								...
								<div class="widget-box">
									...
									<div class="widget-body">
										...
										<div id="product-option-container" style="display: none;">
											...
											<hr>
											<div>
												<button class="btn btn-success btn-small hide" id="product-option-save" data-loading-text="Loading..." type="button"><i class="icon icon-save"></i> Save</button>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="widget-box">
									...
									<div class="widget-body">
										<div class="widget-main padding-8">
											...
											<p class="text-center"><img src="" alt="" id="selected_product_image" style="max-height: 300px; max-width: 100%;"></p>
											<h5 id="selected_product_label" class="text-center"></h5>
							...
							<div id="product_reviews" class="tab-pane">
								<div class="widget-box">
									...
									<div class="widget-body">
										<div class="widget-main">
											<p>You can add review after saving the product.</p>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="span3">
					...
					<div class="widget-box" style="width:100%;">
						...
						<div class="widget-body">
							<div class="widget-main">	
								...
								<p><i>You can set translation for this product after saving.</i></p>
					...
					<div class="widget-box" style="width:100%;">
						...
						<div class="widget-body">
							<div class="widget-main">
								<div id="messageAlertForProductImage"></div>
								<input type="file" id="id-input-file-3" name="image_file"  accept="image/*" onchange="changeImage(this);"/>
								<div class="no-padding" style="width: 234px; height: auto;">
									<img src="<?php echo FRONTEND_URL;?>/images/uploads/default.jpg" id="product_image" alt="" style="width: 100%; height: auto;"/>
								</div>
								<div class="hide">
